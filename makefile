...
RENDERING		= $(RENDERING_DIR)/rendering.c \
				  ...
				  $(RENDERING_DIR)/rays.c \
				  $(RENDERING_DIR)/raycasting.c \
				  $(RENDERING_DIR)/render3d.c \
				  $(RENDERING_DIR)/movement.c

RENDERING_BONUS	= $(RENDERING_DIR)/rendering.c \
				  $(RENDERING_DIR)/draw_bonus.c \
				  $(RENDERING_DIR)/textures.c \
				  $(RENDERING_DIR)/hooks.c \
				  $(RENDERING_DIR)/minimap.c \
				  $(RENDERING_DIR)/rays.c \
				  $(RENDERING_DIR)/raycasting.c \
				  $(RENDERING_DIR)/render3d.c \
				  $(RENDERING_DIR)/movement_bonus.c
...
SOURCES_BONUS	= $(SOURCES_DIR)/main.c \
				  $(SOURCES_DIR)/utils.c \
				  $(SOURCES_DIR)/ft_math.c \
				  $(PARSING) $(RENDERING_BONUS)

OBJECTS			= $(SOURCES:%.c=$(BUILD_DIR)/%.o)
OBJECTS_BONUS	= $(SOURCES_BONUS:%.c=$(BUILD_DIR)/%.o)
...
bonus: fclean
	$(MAKE) OBJECTS="$(OBJECTS_BONUS)" SOURCES="$(SOURCES_BONUS)" $(NAME)
